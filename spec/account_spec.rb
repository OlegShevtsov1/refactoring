RSpec.describe Account do
  before do
    ...
    stub_const('COMMON_PHRASES',
               { create_first_account: "There is no active accounts, do you want to be the first?[y/n]\n",
                 ...
                 you_want_to_delete: 'If you want to delete:',
    ...
    stub_const('CREATE_CARD_PHRASES', [
  ...
  describe '#load' do
    ...
    context 'with active accounts' do
      ...
      before do
        described_class.new(login: login, password: password).create
        allow(current_subject).to receive_message_chain(:gets, :chomp).and_return(*all_inputs)
      end
  ...
  describe '#put_money' do
    ...
    #                 /Money #{correct_money_amount_greater_than_tax} was put on #{custom_card[:number]}.
